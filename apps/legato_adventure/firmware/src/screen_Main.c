...
#define APP_IDLE_SPRITE_DELAY 50
#define APP_JUMP_SPRITE_DELAY 5
#define APP_HURT_SPRITE_DELAY 50
#define APP_RUN_SPRITE_DELAY 12
    ...
    switch (screenState)
    {
        case SCREEN_INIT:
        {
               ...
               leEvent_GetCount() == 0)
            {
                ...
                handleLocomotion = SYS_TIME_CallbackRegisterMS(MainScreen_HandleLocomotion, 0, 60, SYS_TIME_PERIODIC);
